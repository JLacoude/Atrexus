 ...
 */
class Soldier extends DatabaseDriven implements IDisplayable{
  /**
   * @var array Stores soldiers data
   * @access private
   */
  private $_data = array();
  ...
  /**
   * Get magic function to get soldier infos
   *
